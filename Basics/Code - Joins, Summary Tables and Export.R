...
p= qplot(GDP.per.capita.2017,data=Countries_All2
      ,main="GDP plot"
      ,xlab="GDP values"
      ,ylab="frequency")
...
qplot(GDP.per.capita.2017,data=Countries_All2, geom="density"
         ,main="GDP plot"
         ,xlab="GDP values"
         ,ylab="density")

qplot(Region, data=Countries_All2, main="Bar Plot distribution", xlab="Region", ylab="Frequency")

qplot(Region,Under.5.Mortality.Rate.2017, data=Countries_All2, main="2 variables from same dataset", xlab="Region", ylab="Mortality Rate")


qplot(Region,Under.5.Mortality.Rate.2017, data=Countries_All2, geom="boxplot"  , main="2 variables from same dataset", xlab="Region", ylab="Mortality Rate")


qplot(fill= Region,Under.5.Mortality.Rate.2017, data=Countries_All2, geom="density", alpha=I(0.9),main="2 variables from same dataset", xlab="Mortality", ylab="Frequency")
ggsave('sample2.jpeg',width=9,height=6)

ggsave('sample.jpeg',p,width=9,height=6)


qplot(fill= IncomeGroup,Region, data=Countries_All2, geom="bar", alpha=I(0.9),main="colored bar graph", xlab="Region", ylab="Frequency")
ggsave('sample3.jpeg',width=9,height=6)



qplot(GDP.per.capita.2017,Under.5.Mortality.Rate.2017, data=Countries_All2, ,main="2 variables from same dataset", xlab="Mortality", ylab="Frequency")



qplot(GDP.per.capita.2017,Under.5.Mortality.Rate.2017,color=Region, data=Countries_All2, ,main="2 variables from same dataset", xlab="Mortality", ylab="Frequency")
